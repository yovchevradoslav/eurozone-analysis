...
class SimpleVariablesReport(GenericReport):
    ...
    def generate_dataframes(self):
        ...
        return [gdp_growth, debt_to_gdp, trade_balance, unemployment, government_spending, intra_extra_trade, deficit, inflation]
...
class VariabilityToAverageReport(GenericReport):
    ...
    def generate_dataframes(self):
        ...
        return [gdp_growth, trade_balance, unemployment, government_spending, intra_extra_trade, deficit, inflation]
